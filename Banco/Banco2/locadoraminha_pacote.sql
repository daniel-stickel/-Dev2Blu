...
CREATE TABLE `pacote` (
  ...
  `Status_Pacote` enum('Ativo','Inativo') NOT NULL DEFAULT 'Ativo',
  PRIMARY KEY (`Id`),
...
INSERT INTO `pacote` VALUES (1,'Básico',150.00,'Ativo'),(2,'Intermediário',220.50,'Ativo'),(3,'Completo',310.75,'Ativo'),(4,'Mafioso',500.00,'Inativo');
